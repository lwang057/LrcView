...
public class IndicatorSeekBar extends SeekBar {
    ...
    public IndicatorSeekBar(Context context, AttributeSet attrs) {
        ...
        BitmapDrawable drawableBg = (BitmapDrawable) ta.getDrawable(R.styleable.IndicatorSeekBar_one_bitmap);
        bitmapOne = drawableBg.getBitmap();
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        // 参数2 是图片的左边距
        // 参数3 是图片的上边距
        canvas.drawBitmap(bitmapOne, (float) v, -27, mPaint);
    }
